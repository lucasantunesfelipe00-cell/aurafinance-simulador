...
export const AcquisitionCostsModal: React.FC<AcquisitionCostsModalProps> = ({
  ...
  return (
    <section className="w-full max-w-4xl mx-auto editorial-card editorial-card-gold-border p-4 sm:p-8 md:p-10 bg-black rounded-none flex flex-col relative overflow-hidden font-sans animate-fadeIn">

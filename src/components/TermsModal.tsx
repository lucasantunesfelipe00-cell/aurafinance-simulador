...
export const TermsModal: React.FC<TermsModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <section className="w-full max-w-[1060px] mx-auto editorial-card bg-neutral-950/95 border border-amber-400/40 p-4 sm:p-6 rounded-none shadow-[0_0_25px_rgba(245,158,11,0.2)] flex flex-col relative overflow-hidden font-sans animate-fadeIn">

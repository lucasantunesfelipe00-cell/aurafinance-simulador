...
export const ComparatorModal: React.FC<ComparatorModalProps> = ({
  ...
  return (
    <section className="w-full max-w-[1060px] mx-auto editorial-card editorial-card-gold-border p-6 sm:p-10 bg-black rounded-none flex flex-col relative overflow-hidden font-sans animate-fadeIn">
